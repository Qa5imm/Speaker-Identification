...
const AudioRecorder = (props) => {
  ...
  return (
    <div>
      <button onClick={startRecording} disabled={isRecording} id="startRecBtn" hidden={false}>
        Start Recording
      </button>
      <button onClick={stopRec} disabled={!isRecording} id="stopRecBtn" hidden={false}>
        Stop Recording
      </button>
      {/* <button onClick={downloadRecording} disabled={!recordedAudioUrl}>
        Download Recording
      </button> */}
      <audio ref={audioElementRef} src={recordedAudioUrl} id="audioTag" controls hidden={true}/>
      <button onClick={uploadRecording} id="uploadBtn" hidden={true}>
        Upload Recording
      </button>
    </div>
  );
